...
import { RetrieveAvailableTicketsJobPayloadDTO } from '../../../../../../modules/events/dtos/internal/queue/retrieve-available-tickets-job-payload.dto';
...
class GetTicketsAvaliabilityAndMaybeCreateOrderServiceAdapter implements IWebSocketServiceAdapterProvider {
  ...
  async execute(payload: WebSocketMessageDTO): Promise<void> {
    ...
    await this.producerProvider.createJob(QueueNames.RETRIEVE_AVAILABLE_TICKETS, jobPayload);
  }
}
